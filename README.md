[![build](https://github.com/opspec-pkgs/golang.fmt/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/golang.fmt/actions/workflows/build.yml)
